...
function make_great2(originalMagicians: string[]): string[] {
...
let magicianNames2: string[] = ['David ', 'laiba', 'fatima', 'meryam'];

// Call make_great with a copy of the array to create a new array with modified names
let greatMagicians2: string[] = make_great2([...magicianNames2]); // Using the spread operator to create a copy
