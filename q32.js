...
let new_users = ['Alice', 'Eric', 'Bob', 'Megan', 'Frank'];
...
for (let new_username of new_users) {
    ...
    let usernameExists = current_users.some((existing_username) => existing_username.toLowerCase() === new_username.toLowerCase());
