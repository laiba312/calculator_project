...
// Array of programming languages
let programmingLanguages1: string[] = [
  'JavaScript',
  'TypeScript',
  'Python',
  'Java',
...
let invalidLanguage: string = programmingLanguages1[invalidIndex];
...
if (invalidIndex >= 0 && invalidIndex < programmingLanguages1.length) {
  let correctedLanguage: string = programmingLanguages1[invalidIndex];
